<template>
  ...
  >
    <div class="max-w-4xl w-full mx-auto sm:px-6 lg:px-8 pb-4 block md:flex gap-8 justify-between">
      <Logo />
      <nav class="h-auto flex flex-row gap-8 mt-8 md:mt-0 text-slate-70 dark:text-slate-300 justify-center md:justify-end">
